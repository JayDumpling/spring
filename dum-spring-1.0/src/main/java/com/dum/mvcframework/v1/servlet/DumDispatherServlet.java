package com.dum.mvcframework.v1.servlet;
        ...
        for (int i=0;i<parameters.length;i++) {
            ...
            if (paramType == HttpServletRequest.class)
                ...
                if (params.containsKey(requestParam.value())) {
                    String value = Arrays.toString(params.get(requestParam.value())).replaceAll("\\[|\\]", "");
                    paramValues[i] = covert(parameter.getType(),value);
                }
            }
        }
